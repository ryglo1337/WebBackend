...
if($limbs == 0){
	print_r('Выберите один из вариантов!');
	exit();
}
...
foreach($superpowers as $checking){
	if(array_search($checking,$list_sup)=== false){
			print_r('Неверный формат сверхспособностей!');
			exit();
	}
}
...
$user = 'u55100';
$pass = '6571891';
$db = new PDO('mysql:host=localhost;dbname=u55100', $user, $pass, array(PDO::ATTR_PERSISTENT => true));
try {
...
print_r("Данные отправлены в базу данных");
?>
